      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <Link to="/onboarding">
            <Button 
              size="lg" 
              className="bg-primary text-primary-foreground hover:bg-primary/90 font-bold px-8 py-4 text-lg shadow-runway-lg group"
            >
          ...
          <Link to="/home">
            <Button 
              variant="outline" 
              size="lg" 
              className="text-foreground hover:bg-muted font-semibold px-8 py-4 text-lg border border-border"
            >
              Explore Dashboard
            </Button>
          </Link>
